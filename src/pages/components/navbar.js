    ...
    <nav className = "nav">
      <ul className={`Sidebtnlist ${isSidebarVisible ? "show" : "hide"}`}>
       <li className = "Sidelist" onClick={toggleSidebar}><a href="#" className = "Side-a-link" ><svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#1f1f1f"><path d="m256-200-56-56 224-224-224-224 56-56 224 224 224-224 56 56-224 224 224 224-56 56-224-224-224 224Z"/></svg></a></li> 
        ...
        <li className = "Sidelist"><a href="/signin" className = "Side-a-link">About</a></li>
        <li className = "Sidelist"><a href="/signup" className = "Side-a-link" >Report</a></li>
        <li className = "Sidelist"><a href="/report" className = "Side-a-link" >Sign In</a></li> 
      </ul>
     
      
        <ul className="btnList">
        <li className = "list"><a href="/" className = "a-link">Home</a></li>
        <li className = "list hideOnMobile"><a href="/signin" className = "a-link">About</a></li>
        <li className = "list hideOnMobile"><a href="/signup" className = "a-link" >Report</a></li>
        <li className = "list hideOnMobile"><a href="/report" className = "a-link" >Sign In</a></li>
